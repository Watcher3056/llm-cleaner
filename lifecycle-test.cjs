...
const core=require('./clean-subagents.cjs'),{Vault,fingerprint}=require('./backup-vault.cjs'),{pool}=require('./task-pool.cjs'),old=require('./old-chats.cjs'),api=require('./chat-storage.cjs'),wizard=require('./wizard.cjs');
